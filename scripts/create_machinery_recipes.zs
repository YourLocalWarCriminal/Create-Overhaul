...
<recipetype:create:cutting>.addRecipe("boltsteel", <item:kubejs:bolt>*3, <item:immersiveengineering:stick_steel>, 800);
<recipetype:create:cutting>.addRecipe("nailsteel", <item:kubejs:nail>*4, <item:alloyed:steel_sheet>, 800);
