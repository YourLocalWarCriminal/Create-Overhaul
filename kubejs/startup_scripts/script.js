...
onEvent('block.registry', event => {
	...
	.textureAll("kubejs:block/flue_bricks")

	event.create("flue_bottom_bricks")
	.material("stone")
	.hardness(1.0)
	.displayName("Flue bottom Bricks")
	.texture("up", "kubejs:block/flue_bricks")
	.texture("down", "kubejs:block/flue_bricks")
	.texture("east", "kubejs:block/flue_bottom_bricks")
	.texture("west", "kubejs:block/flue_bottom_bricks")
	.texture("north", "kubejs:block/flue_bottom_bricks")
	.texture("south", "kubejs:block/flue_bottom_bricks")
	...
	.texture('down', 'kubejs:block/flue_bricks')
	.texture('south', 'kubejs:block/flue_bottom_bricks')
	.texture('north', 'kubejs:block/flue_furnace_front')
	.texture('west', 'kubejs:block/flue_bottom_bricks')
	.texture('east', 'kubejs:block/flue_bottom_bricks')
	.noItem()
})